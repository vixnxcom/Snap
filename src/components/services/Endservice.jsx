...
const Endservice = () => {
  return (
    <section className={`${styles.flexCenter} flex flex-col bg-each`}>
        ...
        <h1 className='neue-medium text-[28px] p-2 mt-4 text-white mb-4 flex align-items-center text-center  '>
        Each of our services is  <span className='galgo yellow text-7xl tracking-wide'> <br /> crafted</span>
     </h1>
     <p className={`${styles.flexCenter} flex flex-col neue-medium text-[28px] text-white w-[400px] tracking-wide p-2 text-center mx-auto`}>
