...
const About = () => {
  return (
    ...
    <div className='px-4 md:px-16 mt-10'>
      ...
      <p className='neue text-[20px] max-w-[370px] md:max-w-6xl'>
        <span className='text-white text-5xl impact'> SNUK </span>
...
At   <span className='text-white text-5xl impact'> SNUK </span>, we design eyewear that feels like it belongs in tomorrow.
      </p>
