...
const BrandMarquee = () => {
  ...
  return (
    <div className="w-full px-4 md:px-16 mx-auto py-12 overflow-hidden bg-transparent">
      <h1 className='impact  mb-20 text-5xl text-left   md:px-0' style={{ color:'#d3d3d3'}}>
